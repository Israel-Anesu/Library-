...
function addDemoData() {
  addBookToLibrary('Nervous Conditions', 'Tsitsi Dangarebga', '288', true);
  addBookToLibrary('The Grass Is Singing', 'Doris Lessing', '384', true);
  addBookToLibrary('The Stone Virgins', 'Yvonne Vera', '320', true);
  addBookToLibrary('Butterfly Burning', 'Yvonne Vera', '331', true);
